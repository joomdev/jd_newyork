<?php
/**
 * @version   $Id: Filter.php 29018 2015-10-15 21:04:25Z jakub $
...
class RokSprocket_Provider_Wordpress_Filter extends RokSprocket_Provider_AbstractWordpressPlatformFilter
{
	...
	protected function setBaseQuery()
	{
        ...
        $this->base_query .= ' LEFT JOIN '.$wpdb->prefix.'term_taxonomy as tx2 ON (tx2.term_taxonomy_id = tr2.term_taxonomy_id)';
    ...
    /**
   	 * @param $data
   	 */
   	protected function parentpage($data)
   	{
           $this->filter_where[] = 'p.post_parent IN (' . implode(',', $data) . ')';
   	}
