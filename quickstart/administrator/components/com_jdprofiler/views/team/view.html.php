 ...
 * @since  1.6
 */
class JdprofilerViewTeam extends JViewLegacy
{
	protected $state;
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_JDPROFILER_TITLE_TEAM'), 'team.png');
		...
		if ($this->state->params->get('save_history', 1) && $user->authorise('core.edit')) {
			JToolbarHelper::versions('com_jdprofiler.team', $this->item->id);
		}
