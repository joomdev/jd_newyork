...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_jdprofiler&task=profiles.saveOrderAjax&tmpl=component';
...
<form action="<?php echo JRoute::_('index.php?option=com_jdprofiler&view=profiles'); ?>" method="post"
	...
	<div id="j-main-container" class="span10">
		...
		<div id="j-main-container">
			...
			<table class="table table-striped" id="profileList">
				...
				<th class='left'>
				<?php echo JHtml::_('searchtools.sort',  'COM_JDPROFILER_PROFILER_ID', 'a.`id`', $listDirn, $listOrder); ?>
				</th>
				...
				<?php endif; ?>
				<?php if ($canEdit) : ?>
					<a href="<?php echo JRoute::_('index.php?option=com_jdprofiler&task=profile.edit&id='.(int) $item->id); ?>">
