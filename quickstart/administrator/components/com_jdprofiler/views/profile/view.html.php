 ...
 * @since  1.6
 */
class JdprofilerViewProfile extends JViewLegacy
{
	protected $state;
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_JDPROFILER_TITLE_PROFILE'), 'profile.png');
		...
		if ($this->state->params->get('save_history', 1) && $user->authorise('core.edit')) {
			JToolbarHelper::versions('com_jdprofiler.profile', $this->item->id);
		}
