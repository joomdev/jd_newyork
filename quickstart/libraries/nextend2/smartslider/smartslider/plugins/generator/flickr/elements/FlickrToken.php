...
class N2ElementFlickrToken extends N2ElementText {

    protected function fetchElement() {
        N2JS::addInline('new N2Classes.FormElementFlickrToken("' . $this->fieldID . '", "' . N2Base::getApplication('smartslider')->router->createAjaxUrl(array(
