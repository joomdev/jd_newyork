...
class N2ElementInstagramToken extends N2ElementText {

    protected function fetchElement() {

        N2JS::addInline('new N2Classes.FormElementInstagramToken("' . $this->fieldID . '", "' . N2Base::getApplication('smartslider')->router->createAjaxUrl(array(
