        ...
        <?php foreach($list as $i => $item){
            ...
            <div class="TzInner">
                ...
                if(!isset($item -> mediatypes) || (isset($item -> mediatypes) && !in_array($item -> type,$item -> mediatypes))){
                    if($item -> params->get('show_title',1) or $item -> params -> get('show_readmore',1)
                        or $item -> params -> get('show_author', 1) or $item -> params->get('show_created_date', 1)
                        or $item -> params -> get('show_modified_date', 1) or $item -> params -> get('show_publish_date', 1)
                        or $item -> params->get('show_hit', 1) or $item -> params->get('show_tag', 1)
                        or $item -> params->get('show_category_main', 1) or $item -> params->get('show_category_sec', 1)
