...
<div id="tzelement<?php echo $item -> id;?>"
    ...
    <div class="TzInner">
        ...
        ?>
            ...
            ?>
            <?php
            if ($params->get('show_cat_title',1) or $params->get('show_cat_author',0) or $params -> get('show_cat_readmore',1) or $params->get('show_cat_category',0)
        ...
        <div class="TzPortfolioDescription">
            ...
            if ($params->get('show_cat_author',0) or $params -> get('show_cat_intro',1) or $params->get('show_cat_category',0)
                or $params->get('show_cat_create_date',0) or $params->get('show_cat_modify_date',0)
                or $params->get('show_cat_publish_date',0) or $params->get('show_cat_parent_category',0)
                or $params->get('show_cat_hits',0) or $params->get('show_cat_tags',0)
                or !empty($item -> event -> beforeDisplayAdditionInfo)
            ...
            <a class="btn TzPortfolioReadmore<?php if($params -> get('tz_use_lightbox', 1)){
