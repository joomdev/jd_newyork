...
<div id="k2ModuleBox<?php echo $module->id; ?>" class="k2ItemsBlock<?php if($params->get('moduleclass_sfx')) echo ' '.$params->get('moduleclass_sfx'); ?>">
  ...
  <ul>
    ...
    <li class="<?php echo ($key%2) ? "odd col-xs-12 col-sm-6 col-md-6 img-thumbnail" : "even col-xs-12 col-sm-6 col-md-6 img-thumbnail"; if(count($items)==$key+1) echo ' lastItem'; ?>">
      ...
      <div class="moduleItemIntrotext">
      	...
      	<p align="left"><?php if($params->get('itemIntroText')): ?>
